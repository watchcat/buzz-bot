...
| `episode_embeddings` | 384-dim vector embedding (pgvector), KeyBERT topic keywords, source type |
...
Embeddings: all-MiniLM-L6-v2 (384-dim), generated by RunPod Serverless worker. See [RECOMMENDATIONS.md](RECOMMENDATIONS.md) for details.
